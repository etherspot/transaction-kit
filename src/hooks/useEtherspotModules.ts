...
//     try {
//       const getInstallModule = await sdkForChainId.installModule(
//         moduleType,
//         module,
//         initData
//       );
...
//       const generateDeInitData = await sdkForChainId.generateModuleDeInitData(
//         moduleType,
//         module,
//         moduleDeInitData
//       );
...
//       const getUninstallModule = await sdkForChainId.uninstallModule(
//         moduleType,
//         module,
//         generateDeInitData
//       );
...
//     try {
//       const getAllModules =
//         await sdkForChainId.getAllModules(modulesListPageSize);
...
//     try {
//       const getIsModuleInstalled = await sdkForChainId.isModuleInstalled(
//         moduleType,
//         module
//       );
...
//       );
//       throw new Error(
//         `Failed to verify if the module is already installed: ${e}`
//       );
//     }
//   };
